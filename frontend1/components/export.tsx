...
doc.save("Data_pricing.pdf")

  }

  return (
    <div className="flex gap-2">
      <Button onClick={exportToExcel} variant="outline" size="sm" className="bg-chart-5 text-white hover:bg-white hover:text-chart-5 hover:shadow-xl hover:scale-105">
        <Download className="h-4 w-4" />
        Excel
      </Button>
      <Button onClick={exportToPDF} variant="outline" size="sm" className="bg-chart-5 text-white hover:bg-white hover:text-chart-5 hover:shadow-xl hover:scale-105">
        <Download className="h-4 w-4" />
        PDF
      </Button>
    </div>
